...
layout = html.Div(children=[
    ...
    html.Div([
        ...
        the positive and negative percent (you can add "neu_percent" to the y), appear for each one. This could also work as a standalone figure outside of a dash app. '''),

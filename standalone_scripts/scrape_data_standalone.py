...
layout = html.Div(children=[
    html.H2(children='Scraping Twitter Data!'),
     ...
     html.P(children=[
        "(Describe how data was scraped). We followed the ",
    ...
    # html.P(children='''
    #     (Describe how data was scraped). We followed the following tutorial to scrape our Twitter Data: (link)
    # '''),
    ...
    html.P(children='''Code in neccesary helper functions: headers, URL, and connecting to the endpoint.''')

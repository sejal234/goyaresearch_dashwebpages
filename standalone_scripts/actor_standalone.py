#BARCHART except its standalone i just need to figure this out
...
app.layout = html.Div(children=[
    ...
    html.Div(children='''Exploring the sentiment behind reactions to the Goya Boycott.'''),
    dcc.Graph(id='fig', figure=fig)  # Assign the `fig` to the `figure` property
])
